...
class Widget_IdleGame {
    ...
    updateDisplay() {
      ...
      if (elapsed.diff >= 12 &&!this.bonusShown && !localStorage.getItem('tutorialCompleted')) {
    ...
    showRandomBonusButton() {
      ...
      randomBonusSpawn() {
        setInterval(() => {
          ...
          if (chance <= 0.05) {  // 5% de chance de réapparaitre chaque seconde
